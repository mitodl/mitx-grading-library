...
def test_debug_message():
    ...
    expected_message = (
        ...
        "==============================================<br/>\n"
        "Variables: {{'infty': inf, {u}'e': 2.718281828459045, {u}'i': 1j, {u}'j': 1j, u's': 5.530375019455111, u'x': 5.530375019455111, {u}'pi': 3.141592653589793}}<br/>\n"
        "<br/>\n"
...
def test_debug_message_complex_integrand():
    ...
    expected_message = (
        ...
        "Integration Data for Sample Number 0<br/>\n"
        "==============================================<br/>\n"
        "Variables: {{'infty': inf, {u}'e': 2.718281828459045, {u}'i': 1j, {u}'j': 1j, {u}'s': 1.8831785881043805, {u}'x': 0.022981166359782736, {u}'pi': 3.141592653589793}}<br/>\n"
        "<br/>\n"
        "========== Student Integration Data, Real Part<br/>\n"
